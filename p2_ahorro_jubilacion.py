# https://replit.com/join/cdccifobml-azul-esmeraldae

# Crea un programa que ayude a una persona a calcular cuánto necesita ahorrar mensualmente para su jubilación. Solicita al usuario su edad actual, 
#Solicita al usuario su edad actual, la edad a la que planea jubilarse y la cantidad deseada para la jubilación. 
#Luego, calcula cuánto debe ahorrar mensualmente considerando un rendimiento anual esperado de la inversión.
#Utiliza la fórmula:
...
print("Debers ahorrar mensualmente: ",(int(pago_m_n)))
