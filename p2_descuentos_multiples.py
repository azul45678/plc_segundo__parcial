#LINK: https://replit.com/join/pmgnngcryj-azul-esmeraldae
...
# Pedir el precio y la categoría al usuario
...
# aaplica descuento adicional del 5% si se compran más de 10 unidades 
if unidades > 10:
...
print("El precio final es de: ",(int(precio_final)))
